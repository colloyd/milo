...
const inputIcon = `<svg title="Ask AI" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
<mask id="mask0_1759_6665" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="26" height="26">
...
</mask><g mask="url(#mask0_1759_6665)"><rect width="26" height="26" fill="url(#paint0_linear_1759_6665)"/></g><defs><linearGradient id="paint0_linear_1759_6665" x1="-4.82083" y1="7.8963" x2="35.6711" y2="13.6628" gradientUnits="userSpaceOnUse"><stop offset="0.059183" stop-color="#9A3CF9"/><stop offset="0.344409" stop-color="#E743C8"/><stop offset="0.58317" stop-color="#ED457E"/><stop offset="0.84223" stop-color="#FF7918"/></linearGradient></defs>
</svg>`;
const closeIcon = '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><mask id="mask0_1693_6241" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="20" height="20"><path d="M7.74243 6.99999L11.387 3.35576C11.592 3.15068 11.592 2.81845 11.387 2.61337C11.1819 2.40829 10.8497 2.40829 10.6446 2.61337L7 6.25761L3.35542 2.61337C3.15034 2.40829 2.81812 2.40829 2.61304 2.61337C2.40796 2.81845 2.40796 3.15068 2.61304 3.35576L6.25757 6.99999L2.61304 10.6442C2.40796 10.8493 2.40796 11.1815 2.61304 11.3866C2.71557 11.4891 2.8499 11.5404 2.98423 11.5404C3.11855 11.5404 3.25288 11.4892 3.35542 11.3866L6.99999 7.74238L10.6446 11.3866C10.7471 11.4891 10.8814 11.5404 11.0158 11.5404C11.1501 11.5404 11.2844 11.4892 11.387 11.3866C11.592 11.1815 11.592 10.8493 11.387 10.6442L7.74243 6.99999Z" fill="#292929"/></mask><g mask="url(#mask0_1693_6241)"><rect width="14" height="14" fill="#292929"/></g></svg>';
...
function decorateInput(el, input) {
  ...
  if (el.classList.contains('sticky')) {
    const mobileButton = createTag('button', { class: 'bc-mobile-button' }, `${inputIcon}`);
    const toggleMobileButton = () => {
      // DOM removal is required over simply hiding with css because of a bug where
      // the same svg used for label and mobile button will disappear if one is hidden
      if (aboveMobile.matches && fieldContainer.contains(mobileButton)) {
        fieldContainer.removeChild(mobileButton);
      } else {
    ...
    window.addEventListener('resize', debounce(toggleMobileButton, 100));
